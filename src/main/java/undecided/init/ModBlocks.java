...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> HYDROLITH_BRICKS = registerWithItem("hydrolith_bricks", Block::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.PRISMARINE));
    public static final DeferredBlock<Block> HYDROLITH_MOSAIC = registerWithItem("hydrolith_mosaic", Block::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.PRISMARINE));
    public static final DeferredBlock<Block> CHISELED_HYDROLITH_BRICKS = registerWithItem("chiseled_hydrolith_bricks", Block::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.PRISMARINE));
